...
obj:							#OBJ DIRECTORY TARGET : creates a directory to store .o files
	mkdir -p obj
main: obj/main.o obj/game.o obj/c_airc.o obj/c_pilot.o	#MAIN TARGET : links relocatables (.o) to generate executable (main) | main.o + game.o + (*.o) --> main |
	$(CC) $(CC_FLAGS) -o $@ $^
...
test_c_airc: obj/test_c_airc.o obj/c_airc.o
	$(CC) $(CC_FLAGS) -o $@ $^
obj/test_c_airc.o: src/test_c_airc.cpp src/class/c_airc.cpp
	$(CC) $(CC_FLAGS) -c -o $@ $^

#C_PILOT TEST
test_c_pilot: obj/test_c_pilot.o obj/c_pilot.o
	$(CC) $(CC_FLAGS) -o $@ $^
obj/test_c_pilot.o: src/test/test_c_pilot.cpp src/test/c_pilot.cpp
	$(CC) $(CC_FLAGS) -c -o $@ $^

#C_BOARD TEST
test_c_board: obj/test_c_board.o obj/c_board.o
	$(CC) $(CC_FLAGS) -o $@ $^
obj/test_c_board.o: src/test/test_c_board.cpp src/test/c_board.cpp
	$(CC) $(CC_FLAGS) -c -o $@ $^
